...
import EventTracks from "../../components/Event/EventTracks/EventTracks";
  ...
  return (
    <div className="event-page" id="technohack-page">
      <Helmet>
        <meta
          name="description"
          content="Here is the chance you’ve been waiting for to give wings to your creativity. Give life to your innovative ideas that can be solutions to the problems of today with TechnoHack!"
        />
        <meta
          property="og:site_name"
          content="TechnoHack | Technopreneur 2021"
        />
        ...
        <meta
          property="og:image"
          itemprop="image"
          content="../../assets/technohacklogo.png"
        />
