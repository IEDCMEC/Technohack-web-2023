...
const eventData = [
  ...
  {
    id: 8,
    question: "What is the venue of Technohack?",
    ans: (
      <a
      ...
      >
        Govt. Model Engineering College, Thrikkakara, Ernakulam, Cochin: 682021
      </a>
    ),
  },
  {
  ...
  },
  {
    ...
    ans: (
      <a
        ...
        rel='noreferrer'
      >
        If you have any further questions or concerns, do fill out{" "}
        <span className='coc'>this form.</span> We'll be happy to get in touch
